...
class AnalizadorLexico(var codigoFuente: String) {
    ...
    fun esPalabraReservada(): Boolean {
        ...
        if (caracterActual.isLetter()) {
            ...
            if (lexema == "fun" || lexema == "si"|| lexema == "imprimir" || lexema == "impInversa" || lexema == "retorno"|| lexema == "leer" || lexema == "leerInverso"|| lexema=="entero"|| lexema=="decimal"|| lexema=="vacio" || lexema=="verdadero" || lexema=="falso" || lexema == "log" || lexema == "dom" || lexema == "mientras" || lexema == "imp") {
                obtenerSiguienteCaracter()
